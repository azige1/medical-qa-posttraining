...
PREDICTION_FILE="${PREDICTION_FILE:-results/predictions/${MODEL_TAG}_sql_eval_dev_v1.jsonl}"
REPORT_FILE="${REPORT_FILE:-results/tables/${MODEL_TAG}_sql_eval_dev_v1_report.json}"
ERROR_FILE="${ERROR_FILE:-results/case_studies/${MODEL_TAG}_sql_eval_dev_v1_errors.jsonl}"
REPORT_TO="${REPORT_TO:-none}"
RUN_NAME="${RUN_NAME:-${MODEL_TAG}_sql_eval_dev_v1}"
